...
this.router.navigateByUrl(val, { skipLocationChange: true });;
  ...
  DataItems = [
    ...
    },
    {
      ...
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_2005552723_2_2025_100009_XRD-Instrument.JPG',
    },
    {
      id: 3,
      instrumentId: 0,
      instrumentName:
        'FTIR with Diamond ATR & Pellet accessories (Perkin Elmer Spectrum 2)',
      categoryId: 3,
      isActive: true,
      description:
      ...
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_926534728_2_2025_100014_FTIR-Instrument.JPG',
    },
    {
      id: 4,
      instrumentId: 0,
      ...
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_1449097689_2_2025_100011_Flourescence-Instrument.JPG',
    },
    {
      id: 5,
      instrumentId: 0,
      ...
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_543001469_2_2025_100012_TGA-Instrument.JPG',
    },
    {
      id: 6,
      instrumentId: 0,
      instrumentName:
        'Differential scanning calorimeter (Perkin Elmer DSC 6000)',
      categoryId: 6,
      isActive: true,
      description:
      ...
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_1507892084_2_2025_100013_DSC-Instrument.JPG',
    },
    {
      id: 9,
      instrumentId: 0,
      instrumentName:
        'Gas Chromatography and Mass Spectroscopy, Shimadzu GCMS TQ8040 NX',
      categoryId: 7,
      isActive: true,
      description:
      ...
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_2009182246_2_2025_100008_GCMS-Instrument.JPG',
    },
    {
      id: 10,
      instrumentId: 0,
      instrumentName:
        'High Performance and Liquid Chromatography, Shimadzu Prominence LPGE',
      categoryId: 8,
      isActive: true,
      description:
      ...
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_34620374_2_2025_100007_HPLC-Instrument.JPG',
    },
    {
      id: 11,
      instrumentId: 0,
      instrumentName:
        'Electrochemical workstation, Metrohm: Multi-Channel Autolab AUT.MAC.204',
      categoryId: 9,
      isActive: true,
      description:
      ...
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_1060204202_3_2026_100000_ADP_2248.JPG',
    },
    {
      id: 12,
      instrumentId: 0,
      instrumentName:
        'Density merer (Axis Density Meter with analytical balance ALN-220)',
      categoryId: 10,
      isActive: true,
      description:
      ...
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_382530855_2_2025_100002_Density_Meter-Instrument.jpg',
    },
    {
      id: 13,
      instrumentId: 0,
      ...
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_259413724_2_2025_100003_Refrigerated_Centirfuge-Instrument.JPG',
    },
    {
      id: 14,
      instrumentId: 0,
      instrumentName:
        'Viscometer (LABMAN model of LMDV-200 with small sample adaptor low viscosity adaptor and software.)',
      categoryId: 12,
      isActive: true,
      description:
      ...
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_696381150_2_2025_100001_ADP_2298---.JPG',
    },
    {
      id: 15,
      instrumentId: 0,
      instrumentName:
        'Particle size and Zeta potential analyzer (Malverrn Zetasizer Nano ZS90)',
      categoryId: 13,
      isActive: true,
      description:
      ...
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_284316046_2_2025_100010_Particle_Size-Instrument.JPG',
    },
    {
      id: 21,
      instrumentId: 0,
    ...
    },
    {
      ...
      description: null,
      imageUrl:
        'https://files.lpu.in/umsweb/CIFDocuments/Instrument_507378691_3_2025_100015_noImage.jpg',
    },
  ];
    ...
    this.CIFwebService.GetAllInstrumentsData().subscribe({
      next: (response) => {
        if (response.item1 && response.item1.length > 0) {
          ...
          this.tmpsInstrumentsDataData = response.item1.slice(
            0,
            this.InstrumentsDataData.length,
          );
          this.loadingStates = Array(this.tmpsInstrumentsDataData.length).fill(
            true,
          ); // Initialize loading states
        } else {
          this.InstrumentsDataData = this.DataItems; // added on 17-Feb-26 for static Instrument data
          this.tmpsInstrumentsDataData = this.InstrumentsDataData.slice(
            0,
            this.InstrumentsDataData.length,
          );
          this.loadingStates = Array(this.tmpsInstrumentsDataData.length).fill(
  ...
  events = [
    ...
    },
    {
      ...
      title:
        'Discovering the Crystalline and Nano world using X-ray Diffraction and Particle Size and Zeta Potential Analyzer: A National Workshop',
      date: '(24 - 26 April 2025)',
    },
    {
      img: 'https://www.lpu.in/lpu-assets/images/cif/event-9.jpg',
      title:
        'National Workshop on Advance Research with Field Emission Scanning Electron Microscopy: Exploring the Nano-Structural Imaging',
      date: '(27 - 29 March 2025)',
    },
    {
      img: 'https://www.lpu.in/lpu-assets/images/cif/event-7.jpg',
      title:
        'National Workshop on Advanced Chromatographic Techniques Theory & Applications',
      date: '(19 - 21 September, 2024)',
    },
    {
      img: 'https://www.lpu.in/lpu-assets/images/cif/event-8.jpg',
      title:
        'SHORT-TERM COURSE on Advanced Materials analysis & Characterization Techniques: Hands-on-Training and Data Interpretation',
